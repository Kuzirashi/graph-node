...
pub(crate) struct AscSignature {
    pub kind: AscPtr<AscEnum<AscCurveKind>>,
...
pub(crate) struct AscAccessKeyPermissionValue {
    pub kind: AscPtr<AscEnum<AscAccessKeyPermissionKind>>,
    pub data: AscPayload,
}
...
pub(crate) struct AscActionValue {
    pub kind: AscPtr<AscEnum<AscActionKind>>,
    pub data: AscPayload,
}
...
pub(crate) struct AscSuccessStatus {
    pub kind: AscPtr<AscEnum<AscSuccessStatusKind>>,
    pub data: AscPayload,
}
...
pub(crate) struct AscMerklePathItem {
    ...
    pub direction: AscPtr<AscEnum<AscDirection>>,
}
...
pub(crate) struct AscChunkHeader {
    ...
    pub height_created: AscPtr<AscBlockHeight>,
    pub height_included: AscPtr<AscBlockHeight>,
